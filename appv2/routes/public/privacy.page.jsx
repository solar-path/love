    ...
    <>
      <div className="flex flex-col space-y-2 text-justify p-8">
        ...
        <p className="text-justify">
          Aneko (“Company” or “we” or “us”) respects your privacy and is
          committed to protecting it through our compliance with this policy.
          The term "Aneko" refers to Aneko, LLC doing business under the name
          “Aneko”.
        </p>
        <p className="text-justify">
        ...
        <ul className="text-justify list-disc ml-8">
          ...
          <li>
            ...
            between you and this Website. When you interact with our advertising
            and applications on third-party websites and services if those
        ...
        <p className="text-justify">
          ...
          Please note that we do not knowingly collect any personally
          ...
          the age of eighteen (18), please do not attempt to use or register for
          the Website or send any personal information about yourself to us
          before we obtain Parental Consent, except for the Required Information
          for purposes of the Parental Consent process. If you are a parent or
          legal guardian and think that your child under the age of eighteen
          (18) has given us information (beyond the Required Information)
          without our obtaining Parental Consent, please
        ...
        <ul className="text-justify list-disc ml-8">
          <li>
            ...
            e-mail address, industry, workplace company, field of work,
            telephone number, or any other identifier by which a user may be
            contacted online or offline, and credit card number or other payment
            information (via our third-party payment processor that we currently
            use) (collectively, “personal information”);
          </li>
          <li>
        ...
        <ul className="text-justify list-disc ml-8">
          <li>
            ...
            our Website, subscribing to our service, posting material,
            interactive comments or chats with other Users and visible to public
            visitors of the Website, or requesting further services. We may also
        ...
        <ul className="text-justify list-disc ml-8">
          ...
          <li>
            ...
            transfer of some or all of the Company’s assets or equity
            securities, whether as a going concern or as part of bankruptcy,
            liquidation, or similar proceeding, in which personal information
            held by the Company about our Website users is among the assets
            transferred.
          </li>
          <li>
        ...
        <p className="text-justify">
          ...
          with lecture instructors, through features including but not limited
          to “Virtual Community Events,” should you chose to participate in a
          lecture. In order to carry out an interactive course, you hereby
          consent to be in the virtual lecture in which the Users will be able
          to see and hear you, should you activate your device’s camera and
          microphone. The recordings will then be uploaded to a third-party
          video share platform, Vimeo, to an unuled link which will not be
          publicly available. The Company reserves the right to store recordings
          of lectures to be used for replay. As a part of these recordings, the
          viewer will be able to see the recordings of Users who were in the
          lecture for the duration of the lecture. Users hereby provide their
          consent to the Company to photograph, film, videotape, record,
          identify or otherwise use, reproduce, User’s image, name, likeness,
          voice, appearance, and characteristics to use, re-use and duplicate
          the results thereof including, without limitation, all photographs,
          film, video, and/or audio recordings incorporating the User’s
          appearance, in all materials for Company to include in replay videos
          available on the Website for all registered Users.
        </p>
        <p className="text-justify">
          Recordings of user contributions and user information will be stored
          on Vimeo and the Company’s server. The Company retains all personal
          information on its secure server. Lectures held over the third-party
          video conferencing platforms, such as Zoom, will also be stored on
          their respective cloud server. Your data will be stored for up to ten
          (10) years.
        </p>
        <p className="mb-2 text-lg font-semibold">
        ...
        <ul className="text-justify list-disc ml-8">
          ...
          <li>
            ...
            by e-mailing us at{" "}
            <a href="mailto:assanali.tungat@aneko.io">
              assanali.tungat@aneko.io
            </a>
            .
          </li>
          <li>
            ...
            “Unsubscribe” link available in all promotional emails sent through
            our third-party marketing platform, ConvertKit.
          </li>
          <li>
            Targeted Advertising. If you do not want us to use information that
            we collect or that you provide to us to deliver advertisements
            according to our advertisers’ target-audience preferences, you can
        ...
        <ul className="text-justify list-disc ml-8">
          ...
          <li>
            ...
            have the right to request the Company to complete the information
          ...
          <li>
            ...
            the Company’s processing of your personal data, under certain
            conditions.
          </li>
          <li>
            The right to data portability. You have the right to request that
            the Company transfer the data that we have collected to another
        ...
        <p className="text-justify">
          ...
          public areas of the Website like message boards, as applicable. The
